  ...
  return (
    <>
      <div className=" relative flex flex-col h-full w-full">
        <div className="flex flex-col md:flex-row w-full h-auto justify-between gap-4">
          {/* Left Section */}
          <div className="relative text-gray-600 rounded-3xl p-6 bg-white shadow-lg flex flex-col items-center md:items-start w-full md:w-1/4 hover:scale-105 transition-transform">
            <Link to="/dashboard/booking">
              <StatusDiv className="hidden lg:block" />
            </Link>
          </div>

          {/* Right Section */}
          <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 text-white rounded-3xl p-6 shadow-lg flex flex-col justify-between items-center md:items-start w-full md:w-[calc(72%)] h-auto">
            <div>
              ...
              <p className="text-2xl font-bold mb-4 text-center md:text-left">
                Browse through the available halls for your events and secure
        ...
        <div className="flex w-full h-[calc(65%)] justify-between items-center hidden lg:block mt-7">
